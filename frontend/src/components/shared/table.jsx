    ...
    <div className="bg-slate-800/30 backdrop-blur-sm border border-slate-700/50 rounded-lg sm:rounded-xl hover:border-[#00FF66]/30 transition-colors overflow-hidden">
      <div className="p-4 sm:p-5 md:p-6">
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-white/80 text-sm sm:text-base">
            <thead>
              <tr className="border-b border-slate-700/50">
                <th className="text-left py-3 px-4 font-medium text-[#00FF66]">
                  Horas
                </th>
                <th className="text-left py-3 px-4 font-medium text-[#00FF66]">
                  Latitud
            ...
            <tbody>
              {data.length > 0 ? (
                ...
                <tr>
                  <td colSpan="4" className="py-8 px-4 text-center text-white/40">
